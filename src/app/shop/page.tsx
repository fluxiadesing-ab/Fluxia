...
const designsData: Record<string, Design> = {
  ...
  "11": {
    ...
    products: [
      { id: "11-1", title: "Smile More, Stress Less Daily Men’s Fitted Poly/Cotton T-Shirt", price: 23.49, description: "This fitted cotton/poly tee should be a staple of everyone's wardrobe. The cotton/poly blend makes for durable wear and a form-fit that won't stretch after a few washes, and the sustainable recycled polyester means you can feel good about looking good.", image: "/assets/pro/11/1.jpg", link: "https://fluxia.myspreadshop.com/smile+more+stress+less+daily-A68ff70e6c20b511065879849?productType=1130&sellable=bNXr2BjpbBIbAx3jOqam-1130-7&appearance=2" },
      { id: "11-2", title: "Smile More, Stress Less Daily Dog Bandana", price: 14.99, description: "Dogs are a man's best friend and this bandana is a dog's best friend. Your dog has a personality in its own right, so let it shine through with this great accessory.", image: "/assets/pro/11/2.jpg", link: "https://fluxia.myspreadshop.com/smile+more+stress+less+daily-A68ff70e6c20b511065879849?productType=611&sellable=bNXr2BjpbBIbAx3jOqam-611-41&appearance=2&size=29" },
      { id: "11-3", title: "Smile More, Stress Less Daily Baby Bib", price: 13.99, description: "Spreadshirt’s baby bib will keep your baby’s clothing clean (for a few minutes, at least). The reinforced Velcro closure makes this one easy-on and easy-off for mom and dad, but just tricky enough so the little one won’t keep taking it off and throwing it on the floor. This is an easy choice for any baby gift — no sizing necessary!", image: "/assets/pro/11/3.jpg", link: "https://fluxia.myspreadshop.com/smile+more+stress+less+daily-A68ff70e6c20b511065879849?productType=1094&sellable=bNXr2BjpbBIbAx3jOqam-1094-205&appearance=2&size=53" },
      { id: "11-4", title: "Smile More, Stress Less Daily Organic Contrast SS Baby Bodysuit", price: 21.99, description: "This sweet baby bodysuit is made with organic cotton for a natural, breathable and soft short-sleeved outfit. The subtle color contrast adds that extra little touch of cuteness. Dressing even the squirmiest baby is a breeze with the envelope-style neckline and easy snap closures.", image: "/assets/pro/11/4.jpg", link: "https://fluxia.myspreadshop.com/smile+more+stress+less+daily-A68ff70e6c20b511065879849?productType=1268&sellable=bNXr2BjpbBIbAx3jOqam-1268-10&appearance=796" },
      { id: "11-5", title: "Smile More, Stress Less Daily Infant Baby Rib Dress", price: 19.99, description: "Your little one is going to radiate cutenss in the Infant Baby Rib Dress. This charming dress features a cover-stitched ribbed collar and self-fabric back neck tape that matches the skirt. The sleeves are also cover-stitched, adding durability and a touch of style. The gently gathered skirt hem creates a delightful silhouette, making it perfectly adorable for any occasion. Soft, comfortable, and cute, this dress is just want you need for your baby's wardrobe.", image: "/assets/pro/11/5.jpg", link: "https://fluxia.myspreadshop.com/smile+more+stress+less+daily-A68ff70e6c20b511065879849?productType=3250&sellable=bNXr2BjpbBIbAx3jOqam-3250-10&appearance=1" },
      { id: "11-6", title: "Smile More, Stress Less Daily Toddler Fine Jersey T-Shirt", price: 21.99, description: "Keep your little one comfy and stylish with the Toddler Fine Jersey T-Shirt. Designed with a topstitched ribbed collar and double-needle sleeves and bottom hem for added durability, this top is built to withstand all their adventures. The side seam construction ensures a better fit and a more polished look, making it a perfect everyday staple for toddlers on the move.", image: "/assets/pro/11/6.jpg", link: "https://fluxia.myspreadshop.com/smile+more+stress+less+daily-A68ff70e6c20b511065879849?productType=3319&sellable=bNXr2BjpbBIbAx3jOqam-3319-9&appearance=1400" },
      { id: "11-7", title: "Smile More, Stress Less Daily Baby 5 Star Print One Piece", price: 19.99, description: "Dress your little star in our charming baby bodysuit adorned with a delightful star pattern. With an innovative three snap closure for easy changing and a comfortable fit that allows your baby to move freely. This adorable outfit will keep your little one looking cute and feeling cozy.", image: "/assets/pro/11/7.jpg", link: "https://fluxia.myspreadshop.com/smile+more+stress+less+daily-A68ff70e6c20b511065879849?productType=3027&sellable=bNXr2BjpbBIbAx3jOqam-3027-10&appearance=1242" },
      { id: "11-8", title: "Smile More, Stress Less Daily Baby Fleece One Piece", price: 24.99, description: "Your little one will feel like a real lucky bunny in this cute bodysuit. Cozy ribbed cuffs help create the ultimate comfortable fit. Featuring an easy-on, easy-off snap tape closure, it’ll make dressing your baby child’s play.", image: "/assets/pro/11/8.jpg", link: "https://fluxia.myspreadshop.com/smile+more+stress+less+daily-A68ff70e6c20b511065879849?productType=2426&sellable=bNXr2BjpbBIbAx3jOqam-2426-204&appearance=2" },
    ]
  },
  "12": {
    id: "12",
    ...
    products: [
      { id: "12-1", title: "Women’s Performance Racerback Tank Top", price: 25.49, description: "Look like a breeze in this sweat-wicking tank top during your next workout. This tank can do it all, from yoga to running errands. Bonus: The breathable fabric is ideal for wearing solo or for layering up post-gym.", image: "/assets/pro/12/1.jpg", link: "https://fluxia.myspreadshop.com/easily+distracted+by+sloths+dogs-A68ff4af4c20b511065a2cc50?productType=1544&sellable=J14eRNndGmseLYoqEglm-1544-16&appearance=2" },
      { id: "12-2", title: "Bella + Canvas Unisex Short", price: 36.99, description: "These unisex shorts from Bella + Canvas are the perfect style-conscious transition into the warmer weather. Keep comfortable and look good in the mid-weight, soft sponge fleece fabric, with a tear-away label to eliminate irritation and pockets because – well, we all need pockets.", image: "/assets/pro/12/2.jpg", link: "https://fluxia.myspreadshop.com/easily+distracted+by+sloths+dogs-A68ff4af4c20b511065a2cc50?productType=2376&sellable=J14eRNndGmseLYoqEglm-2376-220&appearance=2" },
      { id: "12-3", title: "American Apparel Women’s Racerneck Tank", price: 22.99, description: "Make a move in this shaped-fit racerneck tank with a sporty close-cut silhouette. The cotton-blend means that it will hold its shape, and the recycled polyester means it will make an impact on your look, not the planet.", image: "/assets/pro/12/3.jpg", link: "https://fluxia.myspreadshop.com/easily+distracted+by+sloths+dogs-A68ff4af4c20b511065a2cc50?productType=2381&sellable=J14eRNndGmseLYoqEglm-2381-16&appearance=2" },
      { id: "12-4", title: "Women's Jogger Short", price: 30.99, description: "Get ready to move! These high-waist, loose fit Jogger Shorts from TriDri are built for functional comfort and designed to give you flexibility and freedom. Made from recycled polyester yarns to ensure sustainability is front of mind.", image: "/assets/pro/12/4.jpg", link: "https://fluxia.myspreadshop.com/easily+distracted+by+sloths+dogs-A68ff4af4c20b511065a2cc50?productType=2420&sellable=J14eRNndGmseLYoqEglm-2420-220&appearance=2" },
      { id: "12-5", title: "Women's Half Zip Cropped Hoodie", price: 38.49, description: "Stay warm and stylish in our Women's Half Zip Cropped Hoodie. Made from a soft, breathable fabric with integrated thumb holes and a practical pouch pocket, it's perfect for everyday wear.", image: "/assets/pro/12/5.jpg", link: "https://fluxia.myspreadshop.com/easily+distracted+by+sloths+dogs-A68ff4af4c20b511065a2cc50?productType=2421&sellable=J14eRNndGmseLYoqEglm-2421-23&appearance=2" },
      { id: "12-6", title: "Women’s Cropped Hoodie & Jogger Short Set", price: 52.99, description: "Elevate your athleisure game with our Women's Cropped Half-Zip Hoodie and High-Waist Jogger Shorts Set. Crafted for both style and comfort, this matching ensemble combines a trendy cropped hoodie with high-waisted, ultra-comfy jogger shorts, making it the ideal choice for workouts or casual outings.", image: "/assets/pro/12/6.jpg", link: "https://fluxia.myspreadshop.com/easily+distracted+by+sloths+dogs-A68ff4af4c20b511065a2cc50?productType=2422&sellable=J14eRNndGmseLYoqEglm-2422-220&appearance=2" },
      { id: "12-7", title: "Women's Boxy Tee", price: 25.99, description: "Indulge in effortless style with our Women's Boxy Tee, boasting an oversized collar for a relaxed modern look. The casual, slightly oversized ladies fit coupled with the boxy cut creates a fashion-forward silhouette that is both comfortable and on-trend. Elevate your everyday look with this wardrobe essential that seamlessly blends comfort, versatility, and contemporary design.", image: "/assets/pro/12/7.jpg", link: "https://fluxia.myspreadshop.com/easily+distracted+by+sloths+dogs-A68ff4af4c20b511065a2cc50?productType=2440&sellable=J14eRNndGmseLYoqEglm-2440-8&appearance=2" },
      { id: "12-8", title: "Women’s Cropped Hoodie", price: 35.49, description: "A must-have hoodie that’s both trendy and comfortable. The slightly cropped, oversized fit with a drawstring at the waist provides a flattering shape. Pair it with some jeans for a casual day look or with your best sweatpants for the ultimate loungewear.", image: "/assets/pro/12/8.jpg", link: "https://fluxia.myspreadshop.com/easily+distracted+by+sloths+dogs-A68ff4af4c20b511065a2cc50?productType=2883&sellable=J14eRNndGmseLYoqEglm-2883-23&appearance=2" },
    ]
  },
};
